# Trevor's Custom WordPress Theme.

Custom theme based on the Sage theme from [Roots](https://roots.io/).

## Styles

* Uses [Chroma](https://github.com/JohnAlbin/chroma) for color management
* [Susy Grids](https://github.com/oddbird/susy)
* [Typey](https://github.com/jptaranto/typey) for typeography.
https://www.previousnext.com.au/blog/using-typey-framework-working-typography-web
* [typebase.css](https://github.com/devinhunt/typebase.css) for organizing the Typey styles.
